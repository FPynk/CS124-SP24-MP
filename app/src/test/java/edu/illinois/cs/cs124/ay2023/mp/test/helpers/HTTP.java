...
public class HTTP {
  ...
  public static <T> TimedResponse<T> testServerGet(String route, int responseCode, Object bodyClass)
      throws IOException {
    // Create the request
    ...
    try (Response response = httpClient.newCall(request).execute()) {
      ...
      if (bodyClass == null) {
        ...
        return new TimedResponse((T) Data.OBJECT_MAPPER.readValue(body.string(), it), responseTime);
...
// md5: 693c509cf129f2bab2e9eee88a8da7b8 // DO NOT REMOVE THIS LINE
