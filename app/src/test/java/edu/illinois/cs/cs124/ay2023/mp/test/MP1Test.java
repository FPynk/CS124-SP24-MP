...
public final class MP1Test {
  ...
  public void test1_SummaryFilter() {
    ...
    summaryFilterHelper(SHUFFLED_SUMMARIES, "ng for Information P", 3, Arrays.asList(169, 200, 53));
  ...
  /**
   * Test search interaction to make sure that the correct courses are shown when the search feature
   * is used.
   */
  @Test(timeout = 10000L)
...
// md5: d2d11639f7a4044216a88064fa619ea0 // DO NOT REMOVE THIS LINE
